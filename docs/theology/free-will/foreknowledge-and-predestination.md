...
“Double predestination” is ambiguous:

- A **symmetrical** account would make election and reprobation parallel positive acts in the same way.
- **Asymmetrical Reformed formulations** distinguish God's effective election from passing over or judicial condemnation for sin. Even where both are within a decree, their causal and moral modes are not treated as equal.
- **Lutheran confessions** teach election to salvation but reject making God the cause of sin or damnation.
- **Catholic teaching** affirms providence and predestination while explicitly denying that God predestines anyone to hell; willful turning from God and persistence are required.

The label should therefore never replace analysis of election, passing over, permission, hardening, and judgment.

## Key distinctions

1. **Foreknowledge is not causation.** Knowing and causing are conceptually different, even if a theory relates them through providence.
2. **Predestination is not foreknowledge.** A divine purpose is not merely awareness of an outcome.
3. **Predestination is not identical to determinism.** Traditions combine it with different accounts of creaturely causation and freedom.
4. **Determinism is not fatalism.** Deliberation can be causally relevant even if the outcome is determined.
...
- [Foreknowledge and Free Will](https://plato.stanford.edu/entries/free-will-foreknowledge/), Stanford Encyclopedia of Philosophy
- [Divine Providence](https://plato.stanford.edu/entries/providence-divine/), Stanford Encyclopedia of Philosophy
- Augustine, [*On the Predestination of the Saints* and *On the Gift of Perseverance*](https://www.newadvent.org/fathers/1512.htm)
- Aquinas, [*Summa theologiae* I, q. 23](https://www.newadvent.org/summa/1023.htm)
- [Catechism of the Catholic Church §§600, 1037](https://www.vatican.va/archive/ENG0015/__P1O.HTM)
- [Formula of Concord, Solid Declaration XI](https://bookofconcord.org/solid-declaration/election/)
- [Westminster Confession III](https://opc.org/wcf.html)
