...
The conceptual map follows the [Stanford Encyclopedia of Philosophy on free will](https://plato.stanford.edu/entries/freewill/) and is checked against primary texts and official doctrinal documents collected in the [source index](sources.md). Ancient and confessional claims are classified cautiously; modern analytic labels are never treated as the authors' own vocabulary unless they used them.
